# Originally from: https://git.xirion.net/0x76/nixos-configs/src/commit/160f3036cff32b5d196f1c0ad44a29f12331bc14/common/services/flood.nix
{ config, pkgs, lib, ... }:
let
  ...
  config = mkIf cfg.enable {
    ...
    systemd.services.flood = {
      ...
      serviceConfig = {
        ...
        ExecStart = ''
          ${cfg.package}/bin/flood \
            --baseuri ${cfg.baseURI} \
            --rundir ${cfg.dataDir} \
            --host ${cfg.host} \
            --port ${toString cfg.port}
            ${optionalString cfg.ssl "--ssl"} \
            --auth ${cfg.authMode}  \
